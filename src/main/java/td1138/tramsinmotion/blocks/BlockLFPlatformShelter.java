...
public class BlockLFPlatformShelter extends BlockContainer {

    public BlockLFPlatformShelter(Material material) {
        super(material.iron);
    ...
    public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack stack) {
        ...
        TileLFPlatformShelter te = (TileLFPlatformShelter) world.getTileEntity(i, j, k);
        if (te != null) {
    ...
    public TileEntity createNewTileEntity(World var1, int meta) {
        return new TileLFPlatformShelter();
    }
