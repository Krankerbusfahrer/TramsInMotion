...
package td1138.tramsinmotion.recipes;
...
public class TramsInMotiontemsRecipeHandler {
    public TramsInMotiontemsRecipeHandler() {
    }
...
//        }
        ...
        GameRegistry.addRecipe(new ItemStack(TramsInMotiontems.itemTramsInMotionRecipeBook, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );
    }
    ...
    public static void initItemRecipes() {
       ...
       var10 = iron.iterator();
        ...
        TrainCraftingManager.instance.addRecipe(new ItemStack(TramsInMotiontems.itemTramsInMotionRecipeBook, 1),  "TTT", "TBT", "TTT", Character.valueOf('T'), Blocks.rail, Character.valueOf('B'), Items.book );
