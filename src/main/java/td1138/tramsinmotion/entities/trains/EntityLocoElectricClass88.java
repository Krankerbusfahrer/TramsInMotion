...
import td1138.tramsinmotion.models.trains.ModelClass88;
...
public class EntityLocoElectricClass88 extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricClass88(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Class_88_Blue.png",new String[]{},
                "default", "DRS Plain Blue Panto Up");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Class_88_Cyan.png",new String[]{},
                "Cyan", "DRS Plain Blue Panto Down");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Class_88_Purple.png",new String[]{},
                "Purple", "DRS Blue Livery Panto Up");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Class_88_Magenta.png",new String[]{},
    ...
    public TrainSound getRunningSound(){
        ...
        return new TrainSound("tctramsinmotion:vl10_idle",0.7f,1,0);}

    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getIdleSound(){

        return new TrainSound("tctramsinmotion:vl10_idle",0.3f,1,0);}
}
