...
import td1138.tramsinmotion.models.trains.ModelClass74;
...
public class EntityLocoDieselClass74 extends DieselTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoDieselClass74(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_Blue.png", new String[]{} ,"default", "Class 74 in BR Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_Grey.png", new String[]{}, "Grey", "Class 74 in BR Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_LightBlue.png", new String[]{}, "Light Blue", "Class 74 in BR Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_Yellow.png", new String[]{}, "Yellow", "Class 74 in BR Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_Black.png", new String[]{}, "Black", "Class 74 in BR Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_74_Green.png", new String[]{}, "Green", "Class 74 in BR Blue livery.");
    ...
    public String getDefaultSkin(){
        return "tctramsinmotion:default";
    }
    /*
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tctramsinmotion:eu07_horn",1f,1,0);}
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getRunningSound(){return new TrainSound("tctramsinmotion:chme3_idle",0.7f,1,0);}
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getIdleSound(){return new TrainSound("tctramsinmotion:chme3_idle",0.3f,1,0);}
}
