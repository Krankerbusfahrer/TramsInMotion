...
import td1138.tramsinmotion.models.trains.ModelNMBSHLE18;
...
public class EntityLocoElectricHLEClass18 extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricHLEClass18(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/hle19_White.png",new String[]{},
                "default", "HLE Class 18");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/hle19_Grey.png",new String[]{},
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getHorn(){return new TrainSound("tctramsinmotion:mg_horn",0.8f,1,0);}
