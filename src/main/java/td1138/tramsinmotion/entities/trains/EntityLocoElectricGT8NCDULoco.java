...
import td1138.tramsinmotion.models.trains.ModelGT8NCDUEnd;
...
public class EntityLocoElectricGT8NCDULoco extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricGT8NCDULoco(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public EntityLocoElectricGT8NCDULoco(World world, double x, double y, double z){
        super(world,x,y,z);
    }
    public EntityLocoElectricGT8NCDULoco(World world){
        super(world);
    }

    @Override
    public String transportName(){return "GT8NCDU Loco";}
    @Override
    public String transportcountry(){return "de";}
    @Override
    public String transportYear(){return "1986";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GT8NC_DU_Red.png",new String[]{},
                "Red", "DVG Livery used during all of its operating time");
    }
    ...
    public String[] additionalItemText() {
        return new String[]{"Duisburgs odd special tram"};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new ModelGT8NCDUEnd()};}
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getHorn(){return new TrainSound("tctramsinmotion:LUwhistle",1f,1,0);}

    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getRunningSound(){

        return new TrainSound("tctramsinmotion:vl10_idle",0.7f,0,0);}

    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getIdleSound(){

        return new TrainSound("tctramsinmotion:vl10_idle",0.3f,0,0);}
}
