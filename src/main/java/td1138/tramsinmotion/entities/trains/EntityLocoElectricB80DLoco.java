...
public class EntityLocoElectricB80DLoco extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricB80DLoco(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public EntityLocoElectricB80DLoco(World world, double x, double y, double z){
        super(world,x,y,z);
    }
    public EntityLocoElectricB80DLoco(World world){
        super(world);
    }

    @Override
    public String transportName(){return "B80D Loco";}
    @Override
    ...
    public String[] additionalItemText() {
        return new String[]{"The Düsseldorf Variant of the extensive B car series"};
    }
