...
import td1138.tramsinmotion.models.trains.ModelClass68;
...
public class EntityLocoDieselClass68 extends DieselTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoDieselClass68(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_68_Blue.png", new String[]{} ,"default", "Class 68 in Plain DRS Blue livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_68_Purple.png", new String[]{}, "Purple", "Class 68 in DRS livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_68_Cyan.png", new String[]{}, "Cyan", "Class 68 in Scotrail  livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_68_LightBlue.png", new String[]{}, "Light Blue", "Class 68 in Tranpennine Express livery.");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID,"textures/trains/Class_68_Grey.png", new String[]{}, "Grey", "Class 68 in Chiltern Railways livery.");
    ...
    @Override
    public TrainSound getHorn(){return new TrainSound("tctramsinmotion:Class88Horn",0.8f,1,0);}
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getRunningSound(){return new TrainSound("tctramsinmotion:Class68Thrash",0.7f,1,1);}
    @SideOnly(Side.CLIENT)
    @Override
