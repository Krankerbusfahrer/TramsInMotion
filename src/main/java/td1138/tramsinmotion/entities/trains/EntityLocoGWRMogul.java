package td1138.tramsinmotion.entities.trains;
...
import td1138.tramsinmotion.models.trains.ModelGWRMogul;
...
public class EntityLocoGWRMogul extends SteamTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoGWRMogul(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Green.png",new String[]{},
                "default", "GWR Mogul 7325 BR Lined Green Collett Cab");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Black.png",new String[]{},
                "Black", "GWR Mogul 5322 BR Black (Preserved)");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_LightBlue.png",new String[]{},
                "LightBlue", "GWR Mogul 4375 BR Unlined Green");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Lime.png",new String[]{},
                "Lime", "GWR Mogul 9319 GWR Green Collett Cab");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Magenta.png",new String[]{},
                "Magenta", "GWR Mogul 6359 BR Green weathered");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Orange.png",new String[]{},
                "Orange", "GWR Mogul 6379 BR Green scrapyard/broken");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Red.png",new String[]{},
                "Red", "GWR Mogul 8341 GWR Green (red route)");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Yellow.png",new String[]{},
                "Yellow", "GWR Mogul 7304 BR Green lined");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Grey.png",new String[]{},
                "Grey", "GWR Mogul 5322 GWR Black");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/GWR_Mogul_Brown.png",new String[]{},
     ...
     */
        ...
        @Override
        public TrainSound getHorn(){return new TrainSound("tctramsinmotion:GWRWhistle",0.8f,1,1);}
        @SideOnly(Side.CLIENT)
        @Override
        public TrainSound getRunningSound(){return new TrainSound("tctramsinmotion:steam_run",0.7f,1,1);}
        @SideOnly(Side.CLIENT)
        @Override
        public TrainSound getIdleSound(){return new TrainSound("tctramsinmotion:steam_idle",0.3f,1,0);}
}
