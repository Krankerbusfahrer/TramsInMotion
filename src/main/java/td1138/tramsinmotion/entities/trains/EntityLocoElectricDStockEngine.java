...
import td1138.tramsinmotion.models.trains.ModelDstockEngine;
...
public class EntityLocoElectricDStockEngine extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricDStockEngine(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Engine_Blue.png",new String[]{},
                "default", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Engine_Grey.png",new String[]{},
                "Grey", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Engine_Orange.png",new String[]{},
                "Orange", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Engine_Red.png",new String[]{},
                "Red", "");
    }
