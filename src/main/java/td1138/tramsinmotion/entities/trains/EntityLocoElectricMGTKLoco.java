...
import td1138.tramsinmotion.models.trains.ModelMGTKLoco;
...
public class EntityLocoElectricMGTKLoco extends ElectricTrain {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityLocoElectricMGTKLoco(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public EntityLocoElectricMGTKLoco(World world, double x, double y, double z){
        super(world,x,y,z);
    }
    public EntityLocoElectricMGTKLoco(World world){
        super(world);
    }

    @Override
    public String transportName(){return "MGT-K Loco";}
    @Override
    ...
    @Override
    public float[] getHitboxSize() {return new float[]{4f,1.5f,1f};
    }
    ...
    public String[] additionalItemText() {
        return new String[]{"Based on the M8D NF1"};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new ModelMGTKLoco()};}
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public TrainSound getHorn(){return new TrainSound("tctramsinmotion:BombardierBell",1f,1,1);}
