...
public class EntityFreightLessCoWagon extends Freight implements IInventory {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityFreightLessCoWagon(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Blue.png",new String[]{},
                "default", "Less Co2 Blue Low 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Cyan.png",new String[]{},
                "Cyan", "Less Co2 Blue High 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Grey.png",new String[]{},
                "Grey", "Tesco Blue Low 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_LightBlue.png",new String[]{},
                "LightBlue", "CobelFret Blue High 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Red.png",new String[]{},
                "Red", "CAI Red High 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Yellow.png",new String[]{},
                "Yellow", "Russel Blue High 45ft");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/Less_Co2_Brown.png",new String[]{},
                "Brown", "Empty Wagon");
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new td1138.tramsinmotion.models.rollingstock.ModelLessCoWagon()};}
