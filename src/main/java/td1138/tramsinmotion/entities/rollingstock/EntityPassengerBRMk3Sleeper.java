...
import td1138.tramsinmotion.models.rollingstock.ModelBR_MK3_Sleeper;
...
public class EntityPassengerBRMk3Sleeper extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityPassengerBRMk3Sleeper(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Blue.png",new String[]{},
                "default", "BR Blue Grey Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Brown.png",new String[]{},
                "Brown", "BR Chocolate & Cream Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Cyan.png",new String[]{},
                "Cyan", "Caledonian Sleeper Serco Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Green.png",new String[]{},
                "Green", "GWR Green Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Pink.png",new String[]{},
                "Pink", "First ScotRail Caledonian Sleeper Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_Red.png",new String[]{},
                "Red", "BR Crimson & Cream Livery");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/BR_Mk3_Sleeper_White.png",new String[]{},
