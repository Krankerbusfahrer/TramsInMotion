...
import td1138.tramsinmotion.models.rollingstock.ModelSNCBM6Tail;
...
public class EntityPassengerSNCBM6Tail extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityPassengerSNCBM6Tail(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/SNCB_M6_Tail_White.png",new String[]{},
