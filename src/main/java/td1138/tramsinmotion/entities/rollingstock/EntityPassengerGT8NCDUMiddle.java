...
import td1138.tramsinmotion.models.rollingstock.ModelGT8NCDUMiddle;
 ...
 */
public class EntityPassengerGT8NCDUMiddle extends EntityRollingStock implements IPassenger {
    /*private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};*/


    public static final Item thisItem = new ItemRollingStock(new EntityPassengerGT8NCDUMiddle(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);


    public EntityPassengerGT8NCDUMiddle(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
    }
    public EntityPassengerGT8NCDUMiddle(World world){
        super(world);
    }
    ...
    @Override
    public String transportName() {return "GT8NCDU Middle";
    }
    ...
    public float[] getHitboxSize() {
        return new float[]{2.4f,1.5f,1.0f};
    }

    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new ModelGT8NCDUMiddle()};}
