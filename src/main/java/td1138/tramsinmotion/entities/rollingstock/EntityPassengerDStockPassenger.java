...
import td1138.tramsinmotion.models.rollingstock.ModelDstockPassenger;
...
public class EntityPassengerDStockPassenger extends EntityRollingStock implements IPassenger {
    ...
    public static final Item thisItem = new ItemRollingStock(new EntityPassengerDStockPassenger(null), TramsInMotionInfo.modID, TramsInMotion.tabTramsInMotion);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Passenger_Blue.png",new String[]{},
                "default", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Passenger_Grey.png",new String[]{},
                "Grey", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Passenger_Orange.png",new String[]{},
                "Orange", "");
        SkinRegistry.addSkin(this.getClass(), TramsInMotionInfo.modID, "textures/trains/D_Stock_Passenger_Red.png",new String[]{},
                "Red", "");
    }
