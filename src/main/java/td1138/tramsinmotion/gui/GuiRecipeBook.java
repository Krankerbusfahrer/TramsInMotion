...
package td1138.tramsinmotion.gui;
...
import td1138.tramsinmotion.items.ItemRecipeBook;
...
public class GuiRecipeBook extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (this.currPage > 0) {
            this.mc.renderEngine.bindTexture(new ResourceLocation(TramsInMotionInfo.modID, "textures/gui/book/bookright.png"));
            this.drawTexturedModalRect(var5, var6, 0, 0, this.bookImageWidth, this.bookImageHeight + 20);
            this.mc.renderEngine.bindTexture(new ResourceLocation(TramsInMotionInfo.modID, "textures/gui/book/bookleft.png"));
            ...
            this.mc.renderEngine.bindTexture(new ResourceLocation(TramsInMotionInfo.modID, "textures/gui/book/bookcover.png"));
